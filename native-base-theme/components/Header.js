...
export default (variables = variable) => ({
  ...
  '.rounded': {
    'NativeBase.Item': {
      borderRadius: ((Platform.OS === 'ios') && (variables.platformStyle !== 'material')) ? 25 : 3,
    },
  },
  'NativeBase.Left': {
    'NativeBase.Button': {
    ...
    flex: ((Platform.OS === 'ios') && (variables.platformStyle !== 'material')) ? 1 : 0.5,
    alignSelf: 'center',
    alignItems: 'flex-start',
  },
  'NativeBase.Body': {
    flex: 1,
    alignItems: ((Platform.OS === 'ios') && (variables.platformStyle !== 'material')) ? 'center' : 'flex-start',
    alignSelf: 'center',
    'NativeBase.Segment': {
      borderWidth: 0,
      alignSelf: 'flex-end',
